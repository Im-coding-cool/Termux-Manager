...
FRP_ROOT_PATH = global_config.get('frp', 'root_path')
...
# 读取INI文件
config.read(FRP_ROOT_PATH + 'main/config.ini')
...
if __name__ == "__main__":
    ...
    if TERMUX == 'true':
        # 执行命令
        proc.stdin.write("sh " + FRP_ROOT_PATH + "frpc/termux/qi.sh\n")
        proc.stdin.flush()
    else:
        # 执行命令
        proc.stdin.write("sh " + FRP_ROOT_PATH + "frpc/wsl/qi.sh\n")
        proc.stdin.flush()
